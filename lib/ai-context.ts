...
export const priorityServiceLinks: PriorityLink[] = [
  {
    title: "Inbound Call Center Services",
    href: "/solutions/inbound-call-center-services",
    summary: "Live inbound customer support, order support, overflow coverage, IVR, and ACD routing.",
  },
  {
    title: "Outbound Call Center Services",
    href: "/solutions/outbound-call-center-services",
    summary: "Outbound sales, follow-up calls, retention, surveys, and compliant campaign support.",
  },
  {
  ...
  },
  {
    ...
    summary: "Tiered technical support, troubleshooting, help desk coverage, and SaaS/product support.",
  },
  {
    title: "Lead Generation and Appointment Setting",
    href: "/solutions/lead-generation-appointment-setting",
    summary: "B2B lead qualification, appointment setting, fast lead response, and pipeline support.",
  },
  {
    title: "Multilingual Call Center Services",
    href: "/solutions/multilingual-call-center-services",
    summary: "English and Spanish bilingual customer support for national and regional programs.",
  },
  {
    title: "Healthcare Call Center Services",
    href: "/industries/healthcare-call-center-services",
    summary: "Healthcare support with appointment scheduling, patient communications, and compliance-aware workflows.",
  },
  {
    title: "Insurance Call Center Outsourcing",
    href: "/industries/insurance-call-center-outsourcing",
    summary: "Policyholder support, claims intake, renewal assistance, and insurance BPO workflows.",
  },
  {
    title: "Virtual and Remote Support",
    href: "/services/virtual-remote-support",
    summary: "Remote receptionist, answering, overflow, and after-hours coverage for growing teams.",
  },
  {
...
export const priorityBuyerGuideLinks: PriorityLink[] = [
  ...
  },
  {
    ...
    summary: "Compare healthcare BPO providers for patient support, scheduling, and compliance-heavy work.",
  },
  {
    title: "Appointment Setting Companies",
  ...
  },
  {
    ...
    summary: "Compare customer service outsourcing companies for omnichannel CX programs.",
  },
  {
    title: "Lead Generation Companies",
    href: "/blog/top-10-lead-generation-companies-usa",
    summary: "Compare lead generation companies for outbound prospecting, qualification, and sales handoff.",
  },
  {
    title: "Virtual Receptionist Companies",
...
export const answerEngineFaqs = [
  ...
  {
    question: "What call center services can be outsourced?",
    answer:
  ...
  {
    question: "Can Contact Center USA support bilingual or multilingual callers?",
    answer:
  ...
  {
    question: "When should a business outsource its call center?",
    answer:
  ...
  {
    question: "What information is needed for a call center quote?",
    answer:
...
export function absoluteUrl(href: string) {
  return href.startsWith("http") ? href : `${SITE_BASE_URL}${href}`;
}
...
export function buildLlmsText() {
  ...
  const guides = priorityBuyerGuideLinks
    .map((item) => `- ${item.title}: ${absoluteUrl(item.href)} - ${item.summary}`)
    .join("\n");
  const faqs = answerEngineFaqs
    .map((item) => `### ${item.question}\n${item.answer}`)
    .join("\n\n");

  return `# Contact Center USA

> US-based call center outsourcing services for businesses that need inbound support, outbound calling, customer service, technical support, lead generation, appointment setting, multilingual support, and industry-specific BPO programs.
...
export function buildAiText() {
  return `Contact Center USA AI crawler summary

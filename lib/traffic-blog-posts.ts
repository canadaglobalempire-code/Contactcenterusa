...
export const trafficBlogPosts: Record<string, TrafficBlogPost> = {
  "what-is-a-contact-center": {
    ...
    related: [
      ...
      { label: "Call center SLA best practices", href: "/blog/call-center-sla-best-practices" },
      { label: "De-escalation techniques for customer service", href: "/blog/de-escalation-techniques-customer-service" },
    ],
  ...
  "cost-to-outsource-customer-service": {
    ...
    related: [
      ...
      { label: "Answering service cost per month", href: "/blog/how-much-does-an-answering-service-cost-per-month" },
      { label: "How to switch call center providers", href: "/blog/how-to-switch-call-center-providers" },
    ],
  ...
  "dedicated-vs-shared-call-center-agents": {
    ...
    related: [
      ...
      { label: "Call center SLA best practices", href: "/blog/call-center-sla-best-practices" },
      { label: "Cost to outsource customer service", href: "/blog/cost-to-outsource-customer-service" },
    ],
  ...
  "answering-service-vs-virtual-receptionist-vs-call-center": {
    ...
    related: [
      ...
      { label: "Dental answering service", href: "/blog/dental-answering-service" },
      { label: "Lawyer answering service", href: "/blog/lawyer-answering-service" },
    ],
  ...
  "us-based-answering-service": {
    ...
    related: [
      ...
      { label: "Bilingual answering service", href: "/blog/bilingual-answering-service" },
      { label: "Medical office answering service", href: "/blog/medical-office-answering-service" },
    ],
  ...
  "healthcare-bpo-services-guide": {
    ...
    related: [
      ...
      { label: "Healthcare BPO companies in Florida", href: "/blog/healthcare-bpo-companies-florida" },
      { label: "Healthcare BPO companies in Texas", href: "/blog/healthcare-bpo-companies-texas" },
      { label: "Healthcare BPO companies in Tennessee", href: "/blog/healthcare-bpo-companies-tennessee" },
    ],
  ...
  "home-services-call-center-outsourcing-guide": {
    ...
    related: [
      ...
      { label: "Inbound call center services", href: "/solutions/inbound-call-center-services" },
      { label: "After-hours call center best practices", href: "/blog/after-hours-call-center-best-practices" },
  ...
  "insurance-bpo-services-guide": {
    ...
    related: [
      ...
      { label: "Customer service outsourcing companies", href: "/blog/top-10-customer-service-outsourcing-companies-usa" },
      { label: "Financial services call center", href: "/industries/financial-services-call-center" },
      { label: "Insurance BPO companies in Ohio", href: "/blog/insurance-bpo-companies-ohio" },
      { label: "Insurance BPO companies in Texas", href: "/blog/insurance-bpo-companies-texas" },
    ],
  ...
  "ruby-receptionists-alternatives": {
    ...
    related: [
      ...
      { label: "Moneypenny alternatives", href: "/blog/moneypenny-alternatives" },
      { label: "PATLive alternatives", href: "/blog/patlive-alternatives" },
    ],
  ...
  "how-to-switch-call-center-providers": {
    ...
    related: [
      ...
      { label: "How to choose a call center partner", href: "/blog/how-to-choose-call-center-partner" },
      { label: "Call center SLA best practices", href: "/blog/call-center-sla-best-practices" },
      { label: "Top outbound call center companies", href: "/blog/top-10-outbound-call-center-companies-usa" },
    ],
  ...
  "inbound-vs-outbound-call-center": {
    ...
    related: [
      ...
      { label: "Top outbound call center companies", href: "/blog/top-10-outbound-call-center-companies-usa" },
      { label: "What is BPO collections?", href: "/blog/what-is-bpo-collections" },
    ],
  ...
  "patlive-alternatives": {
    ...
    related: [
      ...
      { label: "Answering service pricing guide", href: "/blog/answering-service-pricing" },
      { label: "Moneypenny alternatives", href: "/blog/moneypenny-alternatives" },
      { label: "Virtual receptionist for real estate investors", href: "/blog/us-based-virtual-receptionist-real-estate-investors" },
    ],
  ...
  "after-hours-call-center-best-practices": {
    ...
    related: [
      ...
      { label: "HIPAA medical answering service requirements", href: "/blog/medical-answering-service-hipaa-requirements" },
      { label: "Lawyer answering service", href: "/blog/lawyer-answering-service" },
    ],

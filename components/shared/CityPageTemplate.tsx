...
const testimonials: Record<string, { quote: string; name: string; title: string; company: string; initials: string }> = {
  "New York": { quote: "Contact Center USA transformed our customer support operations. Their agents understand the fast pace of doing business in New York and deliver exceptional service around the clock.", name: "Sarah M.", title: "VP of Operations", company: "Manhattan Financial Group", initials: "SM" },
  "Los Angeles": { quote: "We needed a partner who understood the entertainment industry and could scale with our seasonal demands. Contact Center USA exceeded every expectation.", name: "David R.", title: "Director of CX", company: "Pacific Media Corp", initials: "DR" },
  "Chicago": { quote: "Their Midwest work ethic matches ours perfectly. Since partnering with Contact Center USA, our customer satisfaction scores have increased by 34%.", name: "Michael T.", title: "COO", company: "Lakefront Logistics", initials: "MT" },
  "Houston": { quote: "In the energy sector, every call matters. Contact Center USA provides the reliability and expertise we need to support our clients 24/7.", name: "Jennifer L.", title: "Customer Success Manager", company: "Gulf Coast Energy Solutions", initials: "JL" },
  "Phoenix": { quote: "The rapid growth of our Phoenix-based business demanded a call center partner that could scale fast. Contact Center USA delivered from day one.", name: "Robert K.", title: "CEO", company: "Desert Valley Tech", initials: "RK" },
  "Philadelphia": { quote: "Their understanding of healthcare compliance and patient communication has been invaluable. A true partner in every sense.", name: "Lisa W.", title: "Director of Patient Services", company: "Liberty Health Systems", initials: "LW" },
  "San Antonio": { quote: "Bilingual support was critical for our business. Contact Center USA provides seamless English and Spanish service that our customers love.", name: "Carlos G.", title: "Operations Manager", company: "Alamo Business Services", initials: "CG" },
  "San Diego": { quote: "Their tech-savvy agents handle our biotech customer inquiries with precision and professionalism that reflects our brand perfectly.", name: "Amanda P.", title: "VP of Customer Relations", company: "Coastal Biotech Inc", initials: "AP" },
  "Dallas": { quote: "We evaluated several call center providers and Contact Center USA stood out for their transparency, quality agents, and no-contract flexibility.", name: "Brian H.", title: "CFO", company: "North Texas Financial", initials: "BH" },
  "Austin": { quote: "As a SaaS company, we needed agents who understand technology. Contact Center USA integrated seamlessly with our tools and culture.", name: "Kevin S.", title: "Head of Support", company: "Capital City Software", initials: "KS" },
  "Jacksonville": { quote: "Their insurance-industry expertise and compliance knowledge gave us confidence from the start. Outstanding partner for our growing business.", name: "Patricia N.", title: "Claims Director", company: "First Coast Insurance Group", initials: "PN" },
  "Columbus": { quote: "Contact Center USA helped us reduce response times by 40% while maintaining the quality our policyholders expect.", name: "James D.", title: "SVP Operations", company: "Buckeye Insurance Co", initials: "JD" },
  "Charlotte": { quote: "In banking, trust is everything. Contact Center USA delivers the professionalism and security our customers deserve on every call.", name: "Michelle F.", title: "Head of Customer Experience", company: "Queen City Banking", initials: "MF" },
  "San Francisco": { quote: "Their AI-augmented support perfectly complements our tech-forward approach. We scaled from 50 to 500 daily interactions without missing a beat.", name: "Alex C.", title: "CTO", company: "Bay Area SaaS Ventures", initials: "AC" },
  "Seattle": { quote: "Contact Center USA matches the innovation mindset we value here in Seattle. Their omnichannel solution has been a game-changer for us.", name: "Rachel B.", title: "Director of Operations", company: "Puget Sound Commerce", initials: "RB" },
};
        ...
        <div className="relative z-10 mx-auto max-w-[1536px] px-5 text-center lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              ...
              <a href={siteConfig.phoneHref} className="inline-flex items-center gap-2 rounded-lg border border-white/20 px-8 py-4 text-[15px] font-semibold text-white transition-all hover:bg-white/10">

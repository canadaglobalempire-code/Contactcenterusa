...
const title = "Jacksonville Call Center & BPO Services | US-Based Teams";
const description =
...
export const metadata: Metadata = {
  ...
  ...pageMeta(title, description, "/call-center-services-jacksonville"),
};
...
export default function JacksonvillePage() {
  return (
    <CityPageTemplate
      ...
      businesses="100K+"
      statePage="florida"
      seoContent={[...seoContent, ...cityExtras["jacksonville"].seo]}
      faqs={cityExtras["jacksonville"].faqs}
    />
  );
}

  ...
  return (
    <>
      ...
      <section className="relative min-h-[80vh] overflow-hidden">
        <Image src="/images/cc-discussion.jpg" alt="Customer Acquisition Outsourcing - Lead Generation Call Center by Contact Center USA" fill className="object-cover object-center" priority />
          ...
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
                <Image src="/images/cc-agent-pro.jpg" alt="Customer acquisition team at Contact Center USA" fill className="object-cover" />
              </div>
              ...
              <div className="relative z-10 rounded-2xl bg-white p-10 shadow-xl">
                ...
                <div className="mt-8 flex items-center gap-4 border-t border-gray-100 pt-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">VP of Sales, Apex Growth Partners</div>
                  </div>
                </div>
              </div>
            </motion.div>

      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildAEOBlogPostingSchema({
              ...
              description: "Comprehensive ranking of the best lead generation companies in the USA for 2026, evaluated by pipeline quality, ABM execution, SDR performance, and client ROI.",

        ...
        <div className="mx-auto max-w-[1536px] px-5 lg:px-8">
          ...
          <div>
            ...
            <div className="relative mt-10 aspect-[21/9] overflow-hidden rounded-2xl">
              <Image src="/images/cc-discussion.jpg" alt="US-based virtual receptionist taking motivated seller calls for real estate investors" fill sizes="(max-width: 1280px) 100vw, 1280px" className="object-cover" />
            </div>
          </div>
        </div>
      </section>

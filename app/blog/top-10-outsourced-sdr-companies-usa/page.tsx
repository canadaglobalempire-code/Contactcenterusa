      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildAEOBlogPostingSchema({
              ...
              description: "Comprehensive ranking of the best outsourced SDR companies in the USA for 2026, evaluated on cadence sophistication, US-based SDR talent, sales engagement stack fluency, ICP work, and qualified-meeting accept rates.",

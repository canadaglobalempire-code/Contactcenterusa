      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildAEOBlogPostingSchema({
              ...
              description: "Comprehensive ranking of the best HIPAA-compliant US-based medical answering service companies for 2026, evaluated by BAA terms, live RN triage, EHR integration, encrypted on-call dispatch, and OCR-audit readiness.",

        ...
        <div className="mx-auto max-w-[1536px] px-5 lg:px-8">
          ...
          >
            ...
            <div className="relative mt-10 aspect-[21/9] overflow-hidden rounded-2xl">
              <Image src="/images/hd-agents-working.jpg" alt="Call center agents working at their desks handling customer calls" fill sizes="(max-width: 1280px) 100vw, 1280px" className="object-cover" />
            </div>
          </div>
        </div>
      </section>

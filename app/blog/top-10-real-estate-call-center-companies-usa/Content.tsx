        ...
        <div className="mx-auto max-w-[1536px] px-5 lg:px-8">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                For full-stack real estate lead operations, pair your ISA partner with <Link href="/services/inbound-call-center-services" className="text-red font-semibold hover:underline">inbound call center services</Link>, <Link href="/services/outbound-telemarketing" className="text-red font-semibold hover:underline">outbound telemarketing</Link>, and <Link href="/services/omnichannel-contact-center-solutions" className="text-red font-semibold hover:underline">omnichannel contact center solutions</Link>.
              </p>

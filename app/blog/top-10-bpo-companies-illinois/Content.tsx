...
const companies = [
  ...
  },
  {
    ...
    strengths: "30+ years US-based ops, layered IL compliance (BIPA + ICRAA + IL-PIPA + ITSA), Chicago + downstate footprint, Polish + Spanish bilingual, deep Guidewire/Epic/Salesforce integrations.",
    ...
    highlight: "30+ years of 100% American Illinois CX — BIPA-compliant from day one, ICRAA-licensed, IL-PIPA-ready, and never offshored a single Chicago contact.",
  },
  {
    rank: 8,

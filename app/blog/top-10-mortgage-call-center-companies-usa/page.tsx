...
export const metadata: Metadata = {
  ...
  description:
    "Compare the top 10 mortgage call center companies in the USA for 2026 — ranked by NMLS license sponsorship, TCPA compliance, LOS/CRM integrations (Encompass, BytePro), and refi/purchase fluency.",
  keywords: [

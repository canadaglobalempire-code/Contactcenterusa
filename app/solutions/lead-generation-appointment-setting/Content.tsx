  ...
  return (
    <>
      ...
      <section className="relative min-h-[80vh] overflow-hidden">
        <Image src="/images/cc-office-wide.jpg" alt="Lead Generation Call Center USA - Contact Center USA" fill sizes="(max-width: 1280px) 100vw, 1280px" className="object-cover object-center" priority />
          ...
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
                <Image src="/images/cc-man-laptop.jpg" alt="Lead generation specialists at Contact Center USA" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
              </div>
